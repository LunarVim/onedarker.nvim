...
theme.set_highlights = function()
  ...
  hl(0, "DiagnosticUnderlineHint", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "DiagnosticUnderlineInfo", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "DiagnosticUnderlineWarn", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "DiagnosticUnderlineError", { fg = 'NONE', bg = 'NONE', undercurl=true, })
