...
theme.set_highlights = function()
  ...
  hl(0, "DiagnosticUnderlineHint", { fg = 'NONE', bg = 'NONE', sp = c.hint_blue, undercurl=true, })
  hl(0, "DiagnosticUnderlineInfo", { fg = 'NONE', bg = 'NONE', sp = c.info_yellow, undercurl=true, })
  hl(0, "DiagnosticUnderlineWarn", { fg = 'NONE', bg = 'NONE', sp = c.warning_orange, undercurl=true, })
  ...
  hl(0, "DiagnosticVirtualTextHint", { fg = 'NONE', bg = '#357294' })
  hl(0, "DiagnosticVirtualTextInfo", { fg = 'NONE', bg = '#1D6F63' })
  hl(0, "DiagnosticVirtualTextWarn", { fg = 'NONE', bg = '#866941' })
  hl(0, "DiagnosticVirtualTextError", { fg = 'NONE', bg = '#7D373B' })
