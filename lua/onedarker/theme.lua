...
theme.set_highlights = function()
  ...
  hl(0, "MatchParen", { fg = c.hint_blue, bg = 'NONE', underline=true, })
  ...
  hl(0, "TSWarning", { fg = c.warning_orange, bg = 'NONE' })
  hl(0, "TSQueryLinterError", { fg = c.error_red, bg = 'NONE' })
  hl(0, "TSURI", { fg = c.cyan, bg = 'NONE', underline=true, })
  hl(0, "TSMath", { fg = c.yellow, bg = 'NONE' })
  hl(0, "TSLiteral", { fg = c.orange, bg = 'NONE' })

  -- markdown
  hl(0, "markdownBlockquote", { link = 'String' })
  ...
  hl(0, "markdownLinkText", { fg = c.blue, bg = 'NONE', underdashed=true, })
  ...
  -- LSP
  hl(0, "DiagnosticHint", { fg = c.hint_blue, bg = 'NONE' })
  hl(0, "DiagnosticInfo", { fg = c.info_yellow, bg = 'NONE' })
  hl(0, "DiagnosticWarn", { fg = c.warning_orange, bg = 'NONE' })
  ...
  hl(0, "DiagnosticUnderlineHint", { fg = c.hint_blue, bg = 'NONE', undercurl=true, })
  hl(0, "DiagnosticUnderlineInfo", { fg = c.info_yellow, bg = 'NONE', undercurl=true, })
  hl(0, "DiagnosticUnderlineWarn", { fg = c.warning_orange, bg = 'NONE', undercurl=true, })
  hl(0, "DiagnosticUnderlineError", { fg = c.error_red, bg = 'NONE', undercurl=true, })
  ...
  hl(0, "LspDiagnosticsVirtualTextError", { link = 'LspDiagnosticsError' })
  hl(0, "LspDiagnosticsVirtualTextWarning", { link = 'LspDiagnosticsWarning' })
  hl(0, "LspDiagnosticsVirtualTextInformation", { link = 'LspDiagnosticsInfo' })
  hl(0, "LspDiagnosticsVirtualTextInfo", { link = 'LspDiagnosticsInfo' })
  hl(0, "LspDiagnosticsVirtualTextHint", { link = 'LspDiagnosticsHint' })
  ...
  hl(0, "LspDiagnosticsUnderlineError", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "LspDiagnosticsUnderlineWarning", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "LspDiagnosticsUnderlineInformation", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "LspDiagnosticsUnderlineInfo", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  hl(0, "LspDiagnosticsUnderlineHint", { fg = 'NONE', bg = 'NONE', undercurl=true, })
  ...
  -- Crates
  hl(0, "CratesNvimLoading", { fg = c.hint_blue, bg = 'NONE' })
  hl(0, "CratesNvimVersion", { fg = c.hint_blue, bg = 'NONE' })
  ...
  hl(0, "CodiVirtualText", { fg = c.hint_blue, bg = 'NONE' })
  hl(0, "SniprunVirtualTextOk", { fg = c.hint_blue, bg = 'NONE' })
  hl(0, "SniprunFloatingWinOk", { fg = c.hint_blue, bg = 'NONE' })
  hl(0, "SniprunVirtualTextErr", { fg = c.error_red, bg = 'NONE' })
  hl(0, "SniprunFloatingWinErr", { fg = c.error_red, bg = 'NONE' })
  hl(0, "DapBreakpoint", { fg = c.error_red, bg = 'NONE' })
